...
const Card = (props) => {
    ...
    const removeFavorite = (id) => {
        ...
        API.updateUserRecipe(removeFavorite)
        .then(result => {
            setFavorite(false);
        })
        .then(
    ...
    return (
        <div className="col-md-4 col-sm-12 recipe-div">
            ...
            <div className="card">
                ...
                <img id={`like-${recipe.id}`} src={fav ? "favorite.svg":"favoriteNOT.svg"} height="30px" style={{ opacity: ".75", position: "absolute", right: "10px", top: "10px" }} onClick={()=>{fav ? removeFavorite(recipe.id) : addFavorite(recipe.id)}} />
